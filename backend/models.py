import os
from sqlalchemy import Column, String, Integer, DateTime, Time, ForeignKey, create_engine
...
class Class(db.Model):  
  ...
  lecture = db.relationship('Lecture', backref='class', cascade='all, delete-orphan', lazy=True)

  def __init__(self, name, code, end_date, start_date, created_date, modified_date, instructor_id):
    self.name = name
    self.code = code
...
class Classroom(db.Model):
  ...
  created_date = Column(DateTime(timezone=True), nullable=False)
  modified_date = Column(DateTime(timezone=True), nullable=False)
  lecture = db.relationship('Lecture', backref='classroom', cascade='all, delete-orphan', lazy=True)
  hours = db.relationship('Hours', backref='classroom', cascade='all, delete-orphan', lazy=True)

  def __init__(self, name, building, floor, occupancy, created_date, modified_date):
    self.name = name
...
class Instructor(db.Model):
  ...
  created_date = Column(DateTime(timezone=True), nullable=False)
  modified_date = Column(DateTime(timezone=True), nullable=False)
  classes = db.relationship('Class', backref='instructor', cascade='all, delete-orphan', lazy=True)
...
class Lecture(db.Model):  
  ...
  def __init__(self, name, class_id, classroom_id, start_time, end_time, created_date, modified_date):
    self.name = name
